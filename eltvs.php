				...
				<div class="col">
					...
					<div class="row">
						<div class="col">
							...
							<p>In the ELT (Extract, Load, Transform) paradigm, operational data is loaded directly to the server that
		hosts the data warehouse, into tables that have the same structure as the source tables. The data is
		then transformed “in place,” and loaded into the data warehouse tables.</p>
		<p>The magic lies in the fact that there is one less “hop” between machines; in fact, there is one less platform altogether. This is important because, data movement is a major source of bottlenecks.
			 Having one less platform to buy and maintain, and one less environment for developers to learn are also major advantages.</p>
						</div>
