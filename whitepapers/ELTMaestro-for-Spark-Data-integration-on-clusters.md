...
data integration tools and introduce some of ETLMaestro for Spark's
advanced features.

ELTMaestro for Spark: An ELT solution
-------------------------------------

ELTMaestro for Spark is based on an architectural concept called *ELT.*
...
ELTMaestro's reason for existence is to *enable* the architecture shown
